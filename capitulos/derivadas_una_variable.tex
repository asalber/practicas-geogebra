...
\item Representar gráficamente y estudiar mediante la definición de derivada la derivabilidad de las siguientes funciones en los puntos que se indica:
      ...
      \item $f(x)=|x-1|$ en $x=1$.
            ...
            \begin{indication}
            \begin{enumerate}
            \item Para representarla gráficamente, introducir la función \command{f(x):=|x-1|} en la barra de \field{Entrada} de la \field{Vista CAS} y activar la \field{Vista Gráfica}.
            \item Para calcular la derivada de $f$ por la izquierda en $x=1$ introducir el comando \command{LímiteIzquierda((f(1+h)-f(1))/h, 0)} en la barra de \field{Entrada}.
            \item Para calcular la derivada de $f$ por la derecha en $x=1$ introducir el comando \command{LímiteDerecha((f(1+h)-f(1))/h, 0)} en la barra de \field{Entrada}.
      ...
      \item $g(x)=\left\{
            ...
            \begin{indication}
            \begin{enumerate}
            \item Para representarla gráficamente, introducir la función \command{g(x):=Si(x!=0, sen(1/x), 0)} en la barra de \field{Entrada} de la \field{Vista CAS}.
            \item Para calcular la derivada de $g$ por la izquierda en $x=0$ introducir el comando \command{LímiteIzquierda((g(h)-g(0))/h, 0)} en la barra de \field{Entrada}.
            \item Para calcular la derivada de $g$ por la derecha en $x=0$ introducir el comando \command{LímiteDerecha((g(h)-g(0))/h, 0)} en la barra de \field{Entrada}.
...
\item  Calcular las derivadas de las siguientes funciones hasta el orden 4 y conjeturar cuál sería el valor de la derivada de orden $n$.
      ...
      \item  $f(x)=a^x\log(a)$.
            \begin{indication}
            \begin{enumerate}
            \item Introducir la función \command{f(x):=a\^{}xlog(a)} en la barra de \field{Entrada} de la \field{Vista CAS}.
            \item Para la primera derivada introducir la expresión \command{f'(x)} en la barra de \field{Entrada}.
            \item Para la segunda derivada introducir la expresión \command{f''(x)} en la barra de \field{Entrada}.
            \item Para la tercera derivada introducir la expresión \command{f'''(x)} en la barra de \field{Entrada}.
            \item Para la cuarta derivada introducir la expresión \command{f''''(x)} en la barra de \field{Entrada}.
      ...
      \item  $g(x)=\dfrac{\sen x +\cos x}{2}$.
            \begin{indication}
            \begin{enumerate}
            \item Introducir la función \command{g(x):=(sen(x)+cos(x))/2} en la barra de \field{Entrada} de la \field{Vista CAS}.de la \field{Vista CAS}.
            \item Para la primera dede la \field{Vista CAS}.{g'(x)} en la barra de \field{Entrada}.
            \item Para la segunda dede la \field{Vista CAS}.{g''(x)} en la barra de \field{Entrada}.
            \item Para la tercera dede la \field{Vista CAS}.{g'''(x)} en la barra de \field{Entrada}.
            \item Para la cuarta derivada introducir la expresión \command{g''''(x)} en la barra de \field{Entrada}.
...
\item Calcular las rectas tangente y normal a la gráfica de la función $f(x)=\log(\sqrt{x+1})$ en $x=1$.
      ...
      \begin{indication}
      \begin{enumerate}
      \item Introducir la función \command{f(x):=log(sqrt(x+1))} en la barra de \field{Entrada} de la \field{Vista CAS}.
      \item Para obtener la ecuación de la recta tangente a $f$ en $x=1$ introducir la ecuación $y=f(1)+f'(1)(x-1)$ en la barra de \field{Entrada}.
      \item Para dibujar la recta tangente hacer clic en el círculo que aparece a la izquierda de la expresión anterior.
      \item Para obtener la ecuación de la recta normal a $f$ en $x=1$ introducir la ecuación $y=f(1)-1/f'(1)(x-1)$ en la barra de \field{Entrada}.
...
\item Dada la función
      ...
      \item Representar la gráfica de $g$.
            \begin{indication}
            Para representarla gráficamente, introducir la función \command{g(x):=(2x\^{}3-3x)/(x\^{}2+1)} en la barra de \field{Entrada} de la \field{Vista CAS} y activar la \field{Vista Gráfica}.
            \end{indication}

      \item Calcular la función derivada $g'(x)$ y representar su gráfica.
            \begin{indication}
            \begin{enumerate}
            \item Para obtener la derivada de $g$ introducir la expresión \command{g'(x):=Derivada(g)} en la barra de \field{Entrada}.
      ...
      \item Calcular las raíces de $g'(x).$
            \begin{indication}
            \begin{enumerate}
            \item Para calcular las raíces de $g'$ introducir la expresión \command{Raíz(g'(x))} en la barra de \field{Entrada} y hacer clic sobre el botón de evaluación aproximada.
      ...
      \item Calcular la segunda derivada $g''(x)$ y representar su gráfica.
            \begin{indication}
            \begin{enumerate}
            \item Para obtener la segunda derivada de $g$ introducir la expresión \command{g''(x):=Derivada(g, 2)} en la barra de \field{Entrada}.
            \item Para dibujar la gráfica de $g''$ hacer clic en el círculo que aparece a la izquierda de la expresión anterior.
            \end{enumerate}
            \end{indication}
