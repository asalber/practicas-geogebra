...
\item Dada la función
      ...
      \item Calcular la función derivada $g'(x)$ y representar su gráfica.
            \begin{indication}
            \begin{enumerate}
            \item Para obtener la derivada de $g$ introducir la expresión \command{g'(x)} en la barra de \field{Entrada}.
      ...
      \item Calcular las raíces de $g'(x).$
            \begin{indication}
            \begin{enumerate}
            \item Para calcular las raíces de $g'$ introducir la ecuación \command{g'(x)=0} en la barra de \field{Entrada} y hacer clic sobre el botón de resolución exacta de ecuaciones.
      ...
      \item Calcular la segunda derivada $g''(x)$ y representar su gráfica.
            \begin{indication}
            \begin{enumerate}
            \item Para obtener la segunda derivada de $g$ introducir la expresión \command{g''(x)} en la barra de \field{Entrada}.
            \item Para dibujar la gráfica de $g''$ hacer clic en el círculo que aparece a la izquierda de la expresión anterior.
            \end{enumerate}
            \end{indication}
