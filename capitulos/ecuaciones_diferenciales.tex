...
$q(x,y)=e^y(1+x^{2})$.
\begin{enumerate}
\item Introducir la expresión \command{DSOLVE1\_GEN(-2x(1+\#e\^{}y),\#e\^{}y(1+x\^{}2),x,y,c)}.
\item Hacer clic en el botón \button{Simplificar}.
\end{enumerate}
Para dibujar las curvas integrales:
\begin{enumerate}[resume]
\item Hacer clic en el botón \button{Sustituir}, seleccionar la variable $c$, introducir el valor -1 y hacer clic en el
botón \button{Simplificar}.
\item Hacer clic en el botón \button{Ventana 2D} para pasar a la ventana gráfica 2D.
\item Hacer clic en el botón \button{Representar expresión}.
...
\begin{enumerate}
\item Introducir la expresión \command{DSOLVE1\_GEN(1-y,x\^{}2+x,x,y,c)}.
\item Hacer clic en el botón \button{Simplificar}.
\end{enumerate}
Para dibujar las curvas integrales:
\begin{enumerate}[resume]
...
\begin{enumerate}
\item Introducir la expresión \command{DSOLVE1(xsqrt(1-y\^{}2),ysqrt(1-x\^{}2),x,y,0,1)}.
\item Hacer clic en el botón \button{Simplificar}.
\end{enumerate}
\end{indicacion}
...
\begin{enumerate}
\item Introducir la expresión \command{DSOLVE1(-\#e\^{}y,(1+\#e\^{}x)y,x,y,0,0)}.
\item Hacer clic en el botón \button{Simplificar}.
\end{enumerate}
\end{indicacion}
...
\begin{enumerate}
\item Introducir la expresión \command{DSOLVE1(-sinxcosx+ycosx,1,x,y,0,1)}.
\item Hacer clic en el botón \button{Simplificar}.
\end{enumerate}
\end{indicacion}
\end{enumerate}
...
\begin{enumerate}
\item Introducir la expresión \command{DSOLVE1(-ky,1,x,y,0,13.6)}.
\item Hacer clic en el botón \button{Simplificar}.
\end{enumerate}
Para obtener la constante de disolución se impone la otra condición $y(4)=4.5$:
\begin{enumerate}[resume]
\item Hacer clic en el botón \button{Sustituir}, seleccionar la variable $x$ e introducir el valor $4$, seleccionar la
variable $y$ e introducir el valor $4.5$, y hacer clic en el botón \button{Simplificar} y después en el botón
\button{Aproximar}.
\end{enumerate}
...
\item Hacer clic en el botón \button{Sustituir}, seleccionar la variable $k$ e introducir el valor de la constante calculado antes,
seleccionar la variable $y$ e introducir el valor $0.68$, y hacer clic en el botón \button{Simplificar} y después en el botón
\button{Aproximar}.
\end{enumerate}
\end{indicacion}
