...
\item Dada la función
      ...
      \item Dibujar su gráfica, y a la vista de misma conjeturar el resultado de los siguientes límites:
            ...
            \begin{indication}
            \begin{enumerate}
            \item Para representarla gráficamente, introducir la función \command{f(x):=(1+2/x)\^{}(x/2)} en la barra de \field{Entrada} de la \field{Vista CAS} y activar la \field{Vista Gráfica}.
            \item Para predecir cuáles pueden ser los valores de los límites pedidos, crear un deslizador introduciendo la expresión \command{a:=0} en la barra de \field{Entrada}.
      ...
      \item Calcular los límites anteriores. ¿Coinciden los resultados con los conjeturados?.
            \begin{indication}
            \begin{enumerate}
            \item Para calcular $\lim_{x\rightarrow -2^-} f(x)$ introducir el comando \command{LímiteIzquierda(f(x), -2)} en la barra de \field{Entrada}.
            \item Para calcular $\lim_{x\rightarrow -2^+} f(x)$ introducir el comando \command{LímiteDerecha(f(x), -2)} en la barra de \field{Entrada}.
            \item Para calcular $\lim_{x\rightarrow -\infty} f(x)$ introducir el comando \command{Límite(f(x), -inf)} en la barra de \field{Entrada}.
            \item Para calcular $\lim_{x\rightarrow \infty} f(x)$ introducir el comando \command{Límite(f(x), inf)} en la barra de \field{Entrada}.
            \item Para calcular $\lim_{x\rightarrow 2} f(x)$ introducir el comando \command{Límite(f(x), 2)} en la barra de \field{Entrada}.
            \item Para calcular $\lim_{x\rightarrow 0} f(x)$ introducir el comando \command{Límite(f(x), 0)} en la barra de \field{Entrada}.
            \end{enumerate}
            \end{indication}
      \end{enumerate}
...
\item Dada la función
      ...
      \item Dibujar la gráfica de $g$ y determinar gráficamente si existen asíntotas.
            \begin{indication}
            \begin{enumerate}
            \item Para representarla gráficamente, introducir la función \command{g(x):=Si(x<=0, x/(x-2), x\^{}2/(2x-6))} en la barra de \field{Entrada} de la \field{Vista CAS} y activar la \field{Vista Gráfica}.
      ...
      \item Calcular las asíntotas verticales de $g$ y dibujarlas.
            ...
            \item La función no está definida en los valores que anulen los denominadores en ambos trozos.
                  Para ver las raíces del denominador del primer trozo introducir el comando \command{Raíz(x-2)} en la barra de \field{Entrada}.
                  La única raíz es $x=2$ pero queda fuera de la región correspondiente a este trozo.
            \item Para ver las raíces del denominador del segundo trozo introducir el comando \command{Raíz(2x-6)} en la barra de \field{Entrada}.
      ...
      \item Calcular las asíntotas horizontales de $g$ y dibujarlas.
            ...
            \item Como $\lim_{x\rightarrow -\infty} g(x)=1$, existe una asíntota horizontal $y=1$.
                  Para dibujarla introducir la expresión \command{y=1} en la barra de \field{Entrada}.
      ...
      \item Calcular las asíntotas oblicuas de $g$.
            ...
            \item Para determinar el término independiente hay que calcular el límite $\lim_{x\rightarrow \infty}g(x)-0.5x$.
                  Para ello introducir el comando \command{Límite(g(x)-0.5x, inf)} en la barra de \field{Entrada}.
...
\item Reprentar gráficamente las siguientes funciones y clasificar sus discontinuidades en los puntos que se indica.
      ...
      \item  $f(x)=\dfrac{\sen x}{x}$ en $x=0$.
            ...
            \begin{indication}
            \begin{enumerate}
            \item Para representarla gráficamente, introducir la función \command{f(x):=sen(x)/x} en la barra de \field{Entrada} de la \field{Vista CAS} y activar la \field{Vista Gráfica}.
      ...
      \item $g(x)=\dfrac{1}{2^{1/x}}$ en $x=0$.
            \begin{indication}
            \begin{enumerate}
            \item Para representarla gráficamente, introducir la función \command{g(x):=1/2\^{}(1/x)} en la barra de \field{Entrada} de la \field{Vista CAS}.
      ...
      \item $h(x)=\dfrac{1}{1+e^{\frac{1}{1-x}}}$ en $x=1$.
            \begin{indication}
            \begin{enumerate}
            \item Para representarla gráficamente, introducir la función \command{h(x):=1/(1+e\^{}(1/(1-x)))} en la barra de \field{Entrada} de la \field{Vista CAS}.
            \item Para calcular el límite $\lim_{x\rightarrow 1^-}h(x)$ introducir el comando \command{LímiteIzquierda(h, 1)} en la barra de \field{Entrada}.
            \item Para calcular el límite $\lim_{x\rightarrow 1^+}h(x)$ introducir el comando \command{LímiteDerecha(h, 1)} en la barra de \field{Entrada}.
...
\item  Representar gráficamente y clasificar las discontinuidades de la función
      ...
      \begin{indication}
      \begin{enumerate}
      \item Para representarla gráficamente, introducir la función \command{f(x):=Si(x<0, (x+1)/(x\^{}2-1), 1/e\^{}(1/(x\^{}2-1)))} en la barra de \field{Entrada} de la \field{Vista CAS} y activar la \field{Vista Gráfica}.
      \item En primer lugar hay que encontrar los puntos que quedan fuera del dominio de cada uno de los tramos.
            ...
            Para ver donde se anula $x^2-1$ introducir el comando \command{Raíz(x\^{}2-1)} en la barra de \field{Entrada}.
