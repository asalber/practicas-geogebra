...
\item Se considera la función
      ...
      \item  Dominio.
            \begin{indication}
            \begin{enumerate}
            \item Para representarla gráficamente, introducir la función en la barra de \field{Entrada} de la \field{Vista Algebraica} y activar la \field{Vista Gráfica}.
...
\item Representar en una misma gráfica las funciones $2^{x}, e^{x}, 0.7^{x}, 0.5^{x}$. A la vista de las gráficas obtenidas, indicar cuáles
      ...
      \begin{indication}
      Introducir cada función en la barra de \field{Entrada} de la \field{Vista Algebraica}.
      \end{indication}
