...
\item Representar en una misma gráfica las funciones $2^{x}, e^{x}, 0.7^{x}, 0.5^{x}$.
      ...
      \begin{indication}
      \begin{enumerate}
      \item Introducir la función \command{2\^{}x} en la barra de \field{Entrada} de la \field{Vista CAS}.
      \item Introducir la función \command{e\^{}x} en la barra de \field{Entrada}.
      \item Introducir la función \command{0.7\^{}x} en la barra de \field{Entrada}.
      \item Introducir la función \command{0.5\^{}x} en la barra de \field{Entrada}.
      \item La función exponencial $a^x$ será creciente cuando $a>0$ y decreciente cuando $0<a<1$.
      \end{enumerate}
      \end{indication}
...
\item Representar en una misma gráfica las funciones siguientes, indicando su período y amplitud.
      ...
      \item $\sen{2x}$, $2\sen{x}$, $\sen\frac{x}{2}$.
            \begin{indication}
            \begin{enumerate}
            \item Introducir la función \command{sen(x)} en la barra de \field{Entrada} de la \field{Vista CAS}.
            \item Introducir la función \command{sen(x)+2} en la barra de \field{Entrada}.
            \item Introducir la función \command{sen(x+2)} en la barra de \field{Entrada}.
            \item Introducir la función \command{sen(2x)} en la barra de \field{Entrada}.
            \item Introducir la función \command{2sen(x)} en la barra de \field{Entrada}.
            \item Introducir la función \command{sen(x/2)} en la barra de \field{Entrada}.
            \end{enumerate}
            \end{indication}
      \end{enumerate}
...
\item Representar en una gráfica la función
      ...
      \begin{indication}
      Introducir la función \command{Si[x<=0, -2x, x\^{}2]} en la barra de \field{Entrada}.
      \end{indication}
\end{enumerate}
