...
\item Calcular la recta tangente y el plano normal a la trayectoria
      ...
      \begin{indication}
      \begin{enumerate}
      \item Introducir el comando \command{f(t):=(sen(t),cos(t),sqrt(t))} en la barra de \field{Entrada} de la \field{Vista CAS} y activar a \field{Vista Gráficas 3D}.
      \item Para dibujar el punto de tangencia en la trayectoria, introducir el comando \command{f(pi)} en la barra de \field{Entrada} y hacer clic en el círculo que aparece a la izquierda de esta expresión.
      \item Para calcular y dibujar la recta tangente a la trayectoria, introducir el comando \command{g(t):=f(pi)+f'(pi)t} en la barra de \field{Entrada}.
      \item Para calcular el plano normal a la trayectoria, introducir el comando \command{((x,y,z)-f(pi))f'(pi)=0} en la barra de \field{Entrada}.
...
\item Dada la función $f(x,y)=y^2-x^2$, se pide:
      ...
      \item Dibujar su gráfica y el punto $(1,2,f(1,2))$.
            \begin{indication}
            \begin{enumerate}
            \item Introducir el la función \command{f(x,y):=y\^{}2-x\^{}2} en la barra de \field{Entrada} de la \field{Vista CAS} y activar la \field{Vista Gráficas 3D}.
            \item Introducir el punto \command{(1,2,f(1,2))} en la barra de \field{Entrada} y hacer clic en el círculo que aparece a la izquierda de esta expresión.
            \end{enumerate}
      ...
      \item Dibujar el plano $x=1$. ¿Qué figura forma la intersección de este plano con la gráfica de $f$?
            \begin{indication}
            Introducir el comando \command{x=1} en la barra de \field{Entrada} y hacer clic en el círculo que aparece a la izquierda de esta expresión.
            \end{indication}

      \item Calcular la derivada de $f(1,y)$ en $y=2$.
            \begin{indication}
            \begin{enumerate}
            \item Introducir la expresión \command{Derivada(f(1,y))} en la barra de \field{Entrada}.
            \item Introducir la expresión \command{Sustituye(\$, y=2)} en la barra de \field{Entrada}.
            \end{enumerate}
            \end{indication}

      \item Dibujar el plano $y=2$. ¿Qué figura forma la intersección de este plano con la gráfica de $f$?
            \begin{indication}
            Introducir el comando \command{y=2} en la barra de \field{Entrada} y hacer clic en el círculo que aparece a la izquierda de esta expresión.
            \end{indication}

      \item Calcular la derivada de $f(x,2)$ en $x=1$.
            \begin{indication}
            \begin{enumerate}
            \item Introducir la expresión \command{Derivada(f(x,2))} en la barra de \field{Entrada}.
            \item Introducir la expresión \command{Sustituye(\$, x=1)} en la barra de \field{Entrada}.
            \end{enumerate}
            \end{indication}
      ...
      \item Calcular la derivadas parciales de $f$ en el punto $(1,2)$. ¿Qué conclusiones sacas?
            \begin{indication}
            \begin{enumerate}
            \item Para calcular la derivada parcial con respecto a $x$, introducir el comando \command{f'\_x(x,y):=Derivada(f, x)} en la barra de \field{Entrada}.
            \item Para calcular el valor de la derivada parcial con respecto a $x$ en el punto $(1,2)$, introducir la función \command{f'\_x(1,2)} en la barra de \field{Entrada}.
            \item Para calcular la derivada parcial con respecto a $y$, introducir el comando \command{f'\_y(x,y):=Derivada(f, y)} en la barra de \field{Entrada}.
            \item Para calcular el valor de la derivada parcial con respecto a $y$ en el punto $(1,2)$, introducir la función \command{f'\_y(1,2)} en la barra de \field{Entrada}.
            \end{enumerate}
            \end{indication}
      \end{enumerate}
...
\item Calcular las siguientes derivadas parciales:
      ...
      \item  $\dfrac{\partial }{\partial V}\dfrac{nRT}{V}.$
            \begin{indication}
            Introducir el comando \command{Derivada(nRT/V, V)} en la barra de \field{Entrada} de la \field{Vista CAS}.
            \end{indication}

      \item  $\dfrac{\partial ^{2}}{\partial x\partial y}e^{x+y}\sen(x/y).$
            \begin{indication}
            Introducir el comando \command{Derivada(Derivada(e\^{}(x+y)sen(x/y), y), x)} en la barra de \field{Entrada}.
            \end{indication}
      \end{enumerate}
...
\item Dada la función $f(x,y)=20-4x^2-y^2$, se pide calcular en el punto $(2,-3)$:
      ...
      \item Vector gradiente.
            \begin{indication}
            \begin{enumerate}
            \item Introducir la función \command{f(x,y):=20-4x\^{}2-y\^{}2} en la barra de \field{Entrada} de la \field{Vista CAS}.
            \item Para calcular la derivada parcial con respecto a $x$, introducir el comando \command{f'\_x(x,y):=Derivada(f, x)} en la barra de \field{Entrada}.
            \item Para calcular la derivada parcial con respecto a $y$, introducir el comando \command{f'\_y(x,y):=Derivada(f, x)} en la barra de \field{Entrada}.
            \item Para calcular el vector gradiente, introducir el comando \command{f'(x,y):=(f'\_x, f'\_y)} en la barra de \field{Entrada}.
      ...
      \item Matriz hessiana.
            \begin{indication}
            \begin{enumerate}
            \item Para calcular la derivada parcial de segundo orden $\frac{\partial\^2 f}{\partial x^2}$, introducir el comando \command{f''\_\{xx\}(x,y):=Derivada(f'\_x, x)} en la barra de \field{Entrada}.
            \item Para calcular la derivada parcial de segundo orden $\frac{\partial\^2 f}{\partial y\partial x}$, introducir el comando \command{f''\_\{xy\}(x,y):=Derivada(f'\_x, y)} en la barra de \field{Entrada}.
            \item Para calcular la derivada parcial de segundo orden $\frac{\partial\^2 f}{\partial x\partial y}$, introducir el comando \command{f''\_\{yx\}(x,y):=Derivada(f'\_y, x)} en la barra de \field{Entrada}.
            \item Para calcular la derivada parcial de segundo orden $\frac{\partial\^2 f}{\partial y^2}$, introducir el comando \command{f''\_\{yy\}(x,y):=Derivada(f'\_y, y)} en la barra de \field{Entrada}.
            \item Para calcular la matriz Hessiana, introducir el comando \command{f''(x,y):=\{\{f''\_\{xx\}, f''\_\{yx\}\}, \{f''\_\{xy\}, f''\_\{yy\}\}\}} en la barra de \field{Entrada}.
            \item Para calcular la matriz Hessiana en el punto $(2,-3)$, introducir la función \command{f''(2,-3)} en la barra de \field{Entrada}.
            \end{enumerate}
            \end{indication}

      \item Calcular el hessiano en el punto $(2,-3)$.
            \begin{indication}
            Introducir la expresión \command{Determinante(\$)} en la barra de \field{Entrada}.
            \end{indication}
      \end{enumerate}
...
\item Hallar la recta normal y el plano tangente a la superficie $S: x+2y-\log z +4 =0$ en el punto $(0,-2,1)$ y dibujarlos.
      \begin{indication}
      \begin{enumerate}
      \item Introducir la función \command{f(x,y,z):=x+2y-log(z)+4} en la barra de \field{Entrada} de la \field{Vista CAS}.
      \item Para dibujar la gráfica de la función, introducir la ecuación \command{f(x,y,z)=0} en la barra de \field{Entrada} y activar a \field{Vista Gráficas 3D}.
      \item Para dibujar el punto, introducir el punto \command{(0,-2,1)} en la barra de \field{Entrada} y hacer clic en el círculo que aparece a la izquierda de esta expresión.
      \item Para calcular el gradiente, introducir la expresión \command{f'(x,y,z):=(Derivada(f,x), Derivada(f,y), Derivada(f,z))} en la barra de \field{Entrada}.
      \item Para dibujar la recta normal, introducir la expresión \command{n(t):=(0,-2,1)+f'(0,-2,1)t} en la barra de \field{Entrada}.
      \item Para dibujar el plano tangente, introducir la expresión \command{((x,y,z)-(0,-2,1))f'(0,-2,1)=0} en la barra de \field{Entrada} y hacer clic en el círculo que aparece a la izquierda de esta expresión.
      \end{enumerate}
      \end{indication}
...
\item Calcular la derivada direccional de la función $h(x,y)= 3x^2+y$ en el punto $(0,0)$, en la dirección del vector $(1,1)$.
      \begin{indication}
      \begin{enumerate}
      \item Introducir la función \command{h(x,y):=3x\^{}2+y} en la barra de \field{Entrada} de la \field{Vista CAS}.
      \item Para calcular la derivada parcial con respecto a $x$, introducir el comando \command{h'\_x(x,y):= Derivada(h, x)} en la barra de \field{Entrada}.
      \item Para calcular la derivada parcial con respecto a $y$, introducir el comando \command{h'\_y(x,y):= Derivada(h, y)} en la barra de \field{Entrada}.
      \item Para calcular el vector gradiente, introducir el comando \command{h'(x,y):= (h'\_x, h'\_y}) en la barra de \field{Entrada}.
...
\item Dada la función $f(x,y)=x^3+y^3-3xy$, se pide:
      ...
      \item Definirla y dibujar su gráfica. ¿Puedes identificar a simple vista sus extremos relativos?
            \begin{indication}
            Introducir la función \command{f(x,y):=x\^{}3+y\^{}3-3x*y} en la barra de \field{Entrada} de la \field{Vista CAS} y activar la \field{Vista Gráficas 3D}.
            \end{indication}
      ...
      \item Calcular los puntos críticos que anulan el vector gradiente de $f$.
            ...
            \item Para calcular la derivada parcial con respecto a $y$, introducir el comando \command{f'\_y(x,y):= Derivada(f, y)} en la barra de \field{Entrada}.
            \item Para calcular el vector gradiente, introducir el comando \command{f'(x,y):= (f'\_x, f'\_y} en la barra de \field{Entrada}.
            \item Para obtener los puntos críticos, introducir el comando \command{Resuelve(f'(x,y)=(0,0))} en la barra de \field{Entrada}.
            \end{enumerate}
            \end{indication}
      ...
      \item Determinar los extremos relativos y los puntos de silla de $f$.
            ...
            \item Para calcular la derivada parcial de segundo orden $\frac{\partial\^2 f}{\partial y^2}$, introducir el comando \command{f''\_\{yy\}(x,y):=Derivada(f'\_y, y)} en la barra de \field{Entrada}.
            \item Para calcular la matriz Hessiana, introducir el comando \command{f''(x,y):=\{\{f''\_\{xx\}, f''\_\{yx\}\}, \{f''\_\{xy\}, f''\_\{yy\}\}\}} en la barra de \field{Entrada}.
            \item Para calcular el Hessiano, introducir el comando \command{H(x,y):=Determinante(f'')} en la barra de \field{Entrada}.
            \item Para calcular el Hessiano en el punto crítico $(0,0)$ introducir el comando \command{H(0,0)} en la barra de \field{Entrada}. Como sale negativo hay un punto de silla en $(0,0)$.
            \item Para calcular el Hessiano en el punto crítico $(1,1)$ introducir el comando \command{H(1,1)} en la barra de \field{Entrada}. Como sale positivo hay un extremo relativo en $(1,1)$.
            \item Introducir el comando \command{f''\_\{xx\}(1,1)} en la barra de \field{Entrada}. Como sale positivo se trata de un mínimo relativo en $(1,1)$.
            \end{enumerate}
            \end{indication}
      \end{enumerate}
