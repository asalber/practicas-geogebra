...
\begin{indicacion}
\begin{enumerate}
\item Introducir la expresión \comando{x\^{}2 log(x)} en la ventana de Álgebra.
\item Seleccionar el menú \menu{Calculo > Integrales} o hacer clic en el botón \boton{Calcular integral}.
\item En el cuadro de diálogo que aparece marcar la opción \opcion{Indefinida}, introducir la constante \comando{C} en el campo \campo{Constante} y hacer clic en el botón \boton{Simplificar}.
\end{enumerate}
Una manera más rápida de calcular la integral es introduciendo la expresión \comando{INT(x\^{}2 log(x), x, C)} en la ventana de Álgebra y haciendo clic en el botón \boton{Simplificar}.
\end{indicacion}

\item $\displaystyle \int \frac{\log(\log x)}{x}\,dx$
\begin{indicacion}
Introducir la expresión \comando{INT(log(log(x)), x, C)} en la ventana de Álgebra y haciendo clic en el botón \boton{Simplicar}.
\end{indicacion}

\item $\displaystyle \int \frac{5x^{2}+4x+1}{x^{5}-2x^{4}+2x^{3}-2x^{2}+x}\,dx$
\begin{indicacion}
Introducir la expresión \comando{INT((5x\^{}2+4x+1)/(x\^{}5-2x\^{}4+2x\^{}3-2x\^{}2+x), x, C)} en la ventana de Álgebra y haciendo clic en el botón \boton{Simplificar}.
\end{indicacion}

\item $\displaystyle \int \frac{6x+5}{(x^{2}+x+1)^{2}}\,dx$
\begin{indicacion}
Introducir la expresión \comando{INT((6x+5)/((x\^{}2+x+1)\^{}2), x, C)} en la ventana de Álgebra y haciendo clic en el botón \boton{Simplificar}.
\end{indicacion}
\end{enumerate}
...
\begin{indicacion}
\begin{enumerate}
\item Introducir la expresión \comando{x\^{}3/(x\^{}2+x+1)} en la ventana de Álgebra.
\item Seleccionar el menú \menu{Cálculo > Integrales} o hacer clic en el botón \boton{Calcular integral}.
\item En el cuadro de diálogo que aparece marcar la opción \opcion{Definida}, introducir \comando{-1/2} en el campo \campo{Límite inferior}, introducir \comando{0} en el campo \campo{Límite superior} y hacer clic en el botón \boton{Simplificar}.
\end{enumerate}
Una manera más rápida de calcular la integral es introduciendo la expresión \comando{INT(x\^{}3/(x\^{}2+x+1), x, -1/2, 0)} en la ventana de Álgebra y haciendo clic en el botón \boton{Simplificar}.
\end{indicacion}

\item $\displaystyle \int_2^4 \frac{\sqrt{16-x^{2}}}{x}\,dx$
\begin{indicacion}
Introducir la expresión \comando{INT(sqrt(16-x\^{}2)/x, x, 2, 4)} en la ventana de Álgebra y hacer clic en el botón \boton{Simplificar}.
\end{indicacion}

\item $\displaystyle \int_0^{\frac{\pi}{2}} \frac{dx}{3+\cos(2x)}$
\begin{indicacion}
Introducir la expresión \comando{INT(sqrt(1/(3+cos(2x), x, 0, pi/2)} en la ventana de Álgebra y hacer clic en el botón \boton{Simplificar}.
\end{indicacion}
\end{enumerate}
...
\begin{indicacion}
Introducir la expresión \comando{INT(x\^{}2 exp(-x), x, 2, inf)} en la ventana de Álgebra y hacer clic en el botón \boton{Simplificar}.
\end{indicacion}
...
\begin{enumerate}
\item Definir la función en la ventana de Álgebra introduciendo la expresión \comando{f(x):=x\^{}2-7x+6}.
...
\end{enumerate}
Para calcular el área de la región introducir la expresión \comando{INT(ABS(f(x)), x, 2, 7)} en la ventana de Álgebra y hacer clic en el botón \boton{Simplificar}.

Para dibujar la región introducir la expresión \comando{x>2 $\wedge$ x<7 $\wedge$ y>MIN(0,f(x)) $\wedge$ y<MAX(0,f(x))} en la ventana de Álgebra y hacer clic en el botón \boton{Representar expresión} en la ventana gráfica.
\end{indicacion}
...
\begin{enumerate}
\item Definir la primera función introduciendo la expresión \comando{f(x):=sin x} en la ventana de Álgebra.
\item Abrir una nueva ventana gráfica con el menú \menu{Ventana > Nueva Ventana 2D} y seleccionar el menú \menu{Ventana -> Mosaico Vertical} para ver la ventana de Álgebra y la ventana gráfica a la vez.
\item Hacer clic en el botón \boton{Representar Expresión} en la ventana gráfica.
\item Definir la segunda función introduciendo la expresión \comando{f(x):=cos x} en la ventana de Álgebra y haciendo clic en el botón \boton{Representar Expresión} en la ventana gráfica.
\item Introducir la expresión \comando{x>0 $\wedge$ x<2pi $\wedge$ y>MIN(f(x),g(x)) $\wedge$ y<MAX(f(x),g(x))} en la ventana de Álgebra y hacer clic en el botón \boton{Plot} en la ventana gráfica.
\end{enumerate}
Para calcular el área de la región introducir la expresión \comando{INT(ABS(f(x)-g(x)), x, 0, 2pi)} en la ventana de Álgebra y hacer clic en el botón \boton{Simplificar}.
\end{indicacion}
...
Para dibujar la región:
\begin{enumerate}
\item Definir la función introduciendo la expresión  \comando{f(x):=sqrt(8x)} en la ventana de Álgebra.
\item Abrir una nueva ventana gráfica con el menú \menu{Ventana > Nueva Ventana 2D} y seleccionar el menú \menu{Ventana -> Mosaico Vertical} para ver la ventana de Álgebra y la ventana gráfica a la vez.
\item Hacer clic en el botón \boton{Representar Expresión} en la ventana gráfica.
\item Introducir la expresión \comando{x>0 $\wedge$ x<2 $\wedge$ y>0 $\wedge$ y<f(x)} en la ventana de Álgebra y hacer clic en el botón \boton{Representar Expresión} en la ventana gráfica.
\end{enumerate}
Para calcular el volumen del sólido de revolución introducir la expresión \comando{INT(pi f(x)\^{}2, x, 0, 2)} en la ventana de Álgebra y hacer clic en el botón \boton{Simplificar}.
\end{indicacion}
