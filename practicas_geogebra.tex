...
%	CHAPTERS
%----------------------------------------------------------------------------------------
\input{capitulos/introduccion_geogebra}
\input{capitulos/funciones_elementales}
\input{capitulos/limites_continuidad}
\input{capitulos/derivadas_una_variable}
...
%\include{capitulos/limites_varias_variables} 
\end{document}
